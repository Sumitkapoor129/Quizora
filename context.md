...
4. **Phase 4 — JSON import — NEXT:** validate → preview+hash → confirm (re-validate+re-hash inside one `insertOne`, all-or-nothing, import as DRAFT). Routes `/api/admin/import/validate|confirm`.
